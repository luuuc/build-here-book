...
Choisir une base de données, un prestataire de paiement, un modèle d'hébergement se règle dans l'équipe technique. C'est une question technique, donc ça le reste.

Personne d'extérieur ne regarde, jusqu'à la première facture ou la première panne.
