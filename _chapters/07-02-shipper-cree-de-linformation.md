...
Certains travaux ne peuvent pas sortir chaque semaine. Une intégration de paiement, un flux réglementé, une migration dont le rollback prend une nuit. La fréquence n'a jamais été le principe, le retour l'était. Découpe par valeur livrée plutôt que par couche technique et la plupart des choses se découpent plus finement qu'elles n'en ont l'air. Pas base de données, puis interface, puis intégration. Un utilisateur qui fait une chose complète avant la fin de la semaine deux. Là où même ça échoue, découpe la preuve. Un essai à blanc sur dix pour cent des données. Un rapport qui doit correspondre à l'ancien au centime près. Quelque chose de vérifiable avant le jour où tout en dépend.
