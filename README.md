...
- **Visibilité** — mets ton nom dessus
...
Le format est en [annexe 1](_chapters/a1-comment-ecrire-une-entree.md), les tests en [annexe 2](_chapters/a2-les-douze-tests.md). Envoie l'entrée par mail, ou ouvre une pull request. Si elle tient, elle rejoint le livre sous ton nom.
